...
import AppCommercePlansPreview from '@/pages/patterns/app/commercePlans/AppCommercePlansPreview';
...
export default function PatternAppCommercePlansTemplate({
  config,
}: {
