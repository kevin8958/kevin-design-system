...
import AppSettingsAdminPreview from '@/pages/patterns/app/settingsAdmin/AppSettingsAdminPreview';
...
export default function PatternAppSettingsAdminTemplate({
  config,
}: {
