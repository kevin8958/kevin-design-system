...
import WebCollaborationPreview from '@/pages/patterns/web/collaboration/WebCollaborationPreview';
...
export default function PatternWebCollaborationTemplate({
  config,
}: {
