...
import WebNotificationsInboxPreview from '@/pages/patterns/web/notificationsInbox/WebNotificationsInboxPreview';
...
export default function PatternWebNotificationsInboxTemplate({
  config,
}: {
