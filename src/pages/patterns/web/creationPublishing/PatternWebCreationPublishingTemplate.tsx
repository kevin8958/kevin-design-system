...
import WebCreationPublishingPreview from '@/pages/patterns/web/creationPublishing/WebCreationPublishingPreview';
...
export default function PatternWebCreationPublishingTemplate({
  config,
}: {
