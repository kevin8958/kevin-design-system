...
import WebOnboardingPreview from '@/pages/patterns/web/onboarding/WebOnboardingPreview';
...
export default function PatternWebOnboardingTemplate({
  config,
}: {
