export const todoListDemoTasks: Productivity.TodoTask[] = [
  {
    id: 'task-1',
...
export const todoListPreviewColumns: Productivity.TodoColumn[] = [
  { id: 'todo', label: 'Todo', color: 'primary' },
  { id: 'inProgress', label: 'In Progress', color: 'info' },
  { id: 'done', label: 'Done', color: 'success' },
];

export const todoListPreviewTasks: Productivity.TodoTask[] = [
  {
    id: 'preview-1',
