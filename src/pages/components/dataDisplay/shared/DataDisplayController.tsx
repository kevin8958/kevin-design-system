...
type DataDisplayControllerProps = {
  controls: DataDisplayControlItem[];
};
...
const DataDisplayController = ({
  controls,
}: DataDisplayControllerProps) => {
  return (
