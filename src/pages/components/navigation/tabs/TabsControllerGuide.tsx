...
const sizes: Navigation.TabsSize[] = ['sm', 'md', 'lg'];

const defaultValues = {
  Size: 'md',
} as const;

type TabsControllerGuideProps = {
  size: Navigation.TabsSize;
  onSizeChange: (next: Navigation.TabsSize) => void;
};
...
const TabsControllerGuide = ({
  size,
  onSizeChange,
}: TabsControllerGuideProps) => {
  return (
...
export default TabsControllerGuide;
