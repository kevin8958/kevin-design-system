...
const sizes: Input.TextareaSize[] = ['sm', 'md', 'lg'];
...
type TextareaControllerProps = {
  size: Input.TextareaSize;
  onSizeChange: (next: Input.TextareaSize) => void;
};
...
export default TextareaControllerGuide;
