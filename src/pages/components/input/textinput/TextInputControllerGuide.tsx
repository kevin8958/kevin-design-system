...
const sizes: Input.TextInputSize[] = ['sm', 'md', 'lg'];
...
type TextInputControllerProps = {
  size: Input.TextInputSize;
  onSizeChange: (next: Input.TextInputSize) => void;
};
...
const TextInputControllerGuide = ({
  size,
  onSizeChange,
...
export default TextInputControllerGuide;
