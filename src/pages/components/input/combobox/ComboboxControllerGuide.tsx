...
const sizes: Input.ComboboxSize[] = ['sm', 'md', 'lg'];
...
type ComboboxControllerProps = {
  size: Input.ComboboxSize;
  onSizeChange: (next: Input.ComboboxSize) => void;
};
...
export default ComboboxControllerGuide;
