...
const sizes: Input.RadioSize[] = ['sm', 'md', 'lg'];
...
type RadioControllerProps = {
  ...
  onSizeChange: (next: Input.RadioSize) => void;
};
...
const RadioControllerGuide = ({ size, onSizeChange }: RadioControllerProps) => {
  return (
...
export default RadioControllerGuide;
