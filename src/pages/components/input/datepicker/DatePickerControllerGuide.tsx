...
const sizes: Input.DatepickerSize[] = ['sm', 'md', 'lg'];
...
type DatePickerControllerProps = {
  size: Input.DatepickerSize;
  onSizeChange: (next: Input.DatepickerSize) => void;
};
...
const DatePickerControllerGuide = ({
  size,
  onSizeChange,
...
export default DatePickerControllerGuide;
