...
const sizes: Input.SwitchSize[] = ['sm', 'md', 'lg'];
...
type SwitchControllerProps = {
  size: Input.SwitchSize;
  onSizeChange: (next: Input.SwitchSize) => void;
};
...
export default SwitchControllerGuide;
