...
const sizes: App.AppModalSize[] = ['sm', 'md', 'lg', 'xl', '2xl', 'full'];
const states: App.AppModalState[] = [
  'default',
  'info',
  'success',
  'warning',
...
const positions: App.AppModalPosition[] = ['top', 'center', 'bottom'];
...
type AppModalControllerGuideProps = {
  maxWidth: App.AppModalSize;
  state: App.AppModalState;
  position: App.AppModalPosition;
  onSizeChange: (next: App.AppModalSize) => void;
  onStateChange: (next: App.AppModalState) => void;
  onPositionChange: (next: App.AppModalPosition) => void;
};
...
export default AppModalControllerGuide;
