...
const sizes: App.AppDrawerSize[] = ['sm', 'md', 'lg', 'xl', 'full'];

const defaultValues = {
  Size: 'lg',
} as const;

type AppDrawerControllerGuideProps = {
  size: App.AppDrawerSize;
  onSizeChange: (next: App.AppDrawerSize) => void;
};
...
const AppDrawerControllerGuide = ({
  size,
  onSizeChange,
}: AppDrawerControllerGuideProps) => {
  return (
...
export default AppDrawerControllerGuide;
